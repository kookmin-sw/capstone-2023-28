...
class WriteFeedActivity : BaseActivity<ActivityWriteFeedBinding>() {
    ...
    override fun initBinding() {
        ...
        binding.run {
            ...
            postBtn.setOnClickListener {
                ...
                // 작성된 글이 없으면 업로드 불가
                if(binding.postingEt.text.isBlank()) Toast.makeText(this@WriteFeedActivity, "피드를 작성해주세요", Toast.LENGTH_SHORT).show()
                else posting()
            }
    ...
    private fun openCamera()
    {
        ...
        camUri = this@WriteFeedActivity.contentResolver.insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values)!!
